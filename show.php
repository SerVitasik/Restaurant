	...
	<header>
		<div class="container">
			<div class="header__info">
				...
				<nav>
					<a class="nav__link" href="add.php">Додати страву</a>
				</nav>
			</div>
		</div>
	</header>
				...
				<?php 
					while($dish = mysqli_fetch_assoc($result)){
						...
						<div class="dish__item">
							...
							<div class="dish__text"><a href = "delete.php?del=<?=$dish['id'] ?>">Видалити</a></div>
							<div class="dish__textu"><a href = "update.php?id=<?=$dish['id'] ?>">Редагувати</a></div>
							<div class="dish__a">
